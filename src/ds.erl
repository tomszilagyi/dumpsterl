...
%% examples, please see the User Guide, section <a
%% href="guide/book.html#api-examples">API examples</a>.
...
%% <a href="guide/book.html#spec">The spec</a>.
...
%%     Guide, section <a
%%     href="guide/book.html#timestamp-formats">Timestamp format
%%     support</a>.</li>
%% </ul>
...
%% and options) is to start the dumpsterl shell via `ds:shell()' and
%% then enter `help all'.  The resulting listing is also available as
%% the <a href="shell_ref.txt">shell reference</a>.
...
%% end goal, you should use the function `pretty_print/1' instead.
